export type ServiceType = 'flights' | 'hotels' | 'bnbs' | 'car-rentals' | 'experiences';
...
export const listings: Listing[] = [
  {
    ...
    description: 'Experience the comfort of RwandAir direct flights from Brussels to Kigali. Premium seating, gourmet meals, and friendly service.',
    type: 'flights',
    location: 'Brussels to Kigali',
    image: 'https://images.unsplash.com/photo-1552820728-8ac41f1122a8?w=800&h=600&fit=crop',
    images: [
  ...
  },
  {
    ...
    description: 'Experience luxury at its finest at the Serena Hotel Kigali. Stunning city views, world-class amenities, and impeccable service.',
    type: 'hotels',
    ...
    checkIn: '3:00 PM',
    checkOut: '11:00 AM',
    amenities: ['Swimming Pool', 'Spa', 'Restaurant', 'WiFi', 'Fitness Center', 'Concierge'],
  },
  {
    id: '3',
    title: 'Cozy BnB in Kigali',
    shortDescription: 'Authentic local experience with modern comfort',
    description: 'Stay with a local Rwandan family in this charming BnB. Experience authentic Rwandan hospitality, homemade breakfast, and personal recommendations.',
    type: 'bnbs',
    ...
    checkIn: '2:00 PM',
    checkOut: '10:00 AM',
    amenities: ['Kitchen', 'WiFi', 'Garden', 'Breakfast Included', 'Local Tours'],
  },
  {
    id: '4',
    title: 'Premium Car Rental - Toyota RAV4',
    shortDescription: 'Explore Rwanda at your own pace with modern SUV',
    description: 'Rent a brand new Toyota RAV4 with insurance included. Perfect for exploring Rwanda\'s diverse landscapes safely and comfortably.',
    type: 'car-rentals',
    location: 'Kigali Airport & City',
    image: 'https://images.unsplash.com/photo-1552519507-da3a142c6e3d?w=800&h=600&fit=crop',
    images: [
    ...
    reviews: 421,
    featured: true,
    amenities: ['Insurance Included', 'GPS', 'WiFi Hotspot', '24/7 Support', 'Free Delivery'],
  },
  {
    id: '5',
    title: 'Volcanoes National Park Trek',
    shortDescription: 'Guided gorilla trekking experience in misty mountains',
    description: 'Encounter majestic mountain gorillas in their natural habitat. An unforgettable wildlife experience with expert guides in Volcanoes National Park.',
    type: 'experiences',
    ...
    reviews: 89,
    featured: true,
    amenities: ['Expert Guide', 'Park Entry', 'Transport', 'Breakfast', 'Photography'],
  },
  {
    id: '6',
    title: 'Nyungwe Forest Canopy Walk',
    shortDescription: 'Suspended bridge walk through ancient rainforest',
    description: 'Experience Rwanda\'s largest tropical forest from a unique perspective. Walk suspended 50 meters above the forest floor on the Nyungwe Canopy Walk.',
    type: 'experiences',
    ...
    reviews: 234,
    featured: false,
    amenities: ['Guide Included', 'Safety Equipment', 'Forest Map', 'Photography Time'],
  },
  {
    id: '7',
    title: 'Lake Kivu Resort',
    shortDescription: 'Beachfront paradise with water sports activities',
    description: 'Relax on pristine white sand beaches along Lake Kivu. Enjoy water sports, sunset views, and fresh fish at this serene lakeside resort.',
    type: 'hotels',
    location: 'Lake Kivu',
    ...
    checkIn: '2:00 PM',
    checkOut: '10:00 AM',
    amenities: ['Beach Access', 'Water Sports', 'Restaurant', 'Bar', 'WiFi', 'Boat Tours'],
  },
  {
    id: '8',
    title: 'Paris to Kigali via Brussels',
    shortDescription: 'Convenient connection flight with premium service',
    description: 'Travel from Paris to Kigali with a smooth connection in Brussels. Enjoy flexibility and competitive pricing on European-African routes.',
    type: 'flights',
...
export const galleryImages = [
  {
    ...
    image: 'https://res.cloudinary.com/take-memories/images/f_auto,dpr_auto,q_auto,w_2000,c_fill,h_1200/gm/hbb8oblj5tozmimydbaz/rwanda-sehenswurdigkeiten',
    category: 'mountains',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1466059810696-85e62f9eaa78?w=1200&h=800&fit=crop',
    category: 'landscapes',
...
export const testimonials = [
  {
    ...
    text: 'Murugo made booking my Rwanda trip effortless. The experience of seeing mountain gorillas was life-changing, and every detail was perfectly arranged.',
  ...
  },
  {
    ...
    text: 'I was nervous about traveling to a new country alone, but Murugo\'s support team made me feel safe and welcomed throughout my journey.',
