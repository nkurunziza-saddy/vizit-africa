      ...
      <section className="container mx-auto px-4 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <ExperienceCard
            ...
            location="Huye"
          >
            Trace the journey of the coffee bean from the crop to the cup in the
            heart of Rwanda's coffee region.
          </ExperienceCard>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/20 border border-white/20">
          <div className="relative group overflow-hidden bg-black h-96">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 border border-white/10 m-2">
              ...
              <h3 className="text-4xl text-white font-black uppercase tracking-tighter">
                Cultural Deep Dive
              </h3>
            </div>
          </div>
