...
export function ImigongoParallaxSection() {
  ...
  return (
    ...
    >
      <div className="relative min-h-[60vh] md:min-h-full bg-imigongo-black overflow-hidden group">
        <motion.div
          style={{ y: imageY }}
      ...
      <div className="bg-imigongo-black text-white flex flex-col justify-center p-12 md:p-24 lg:p-32 border-l-4 border-imigongo-ochre relative z-10">
