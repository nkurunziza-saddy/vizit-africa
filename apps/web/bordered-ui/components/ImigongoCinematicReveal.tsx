...
export function ImigongoCinematicReveal() {
  ...
  return (
    <div
      ref={containerRef}
      className="bg-black h-screen relative flex items-center justify-center overflow-hidden"
    >
      ...
      <div className="final-caption absolute bottom-24 left-0 w-full text-center z-20 opacity-0">
        <p className="text-imigongo-ochre uppercase tracking-[0.5em] text-sm font-bold mb-4">
