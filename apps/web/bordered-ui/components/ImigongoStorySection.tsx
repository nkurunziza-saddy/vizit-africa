...
export function ImigongoStorySection({
  imageSrc,
  category,
  title,
  description,
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative min-h-[60vh] md:min-h-full bg-imigongo-black overflow-hidden group",
      ...
      <div
        className={cn(
          "bg-imigongo-black text-white flex flex-col justify-center p-12 md:p-24 lg:p-32 relative z-10",
          reversed
            ? "md:order-1 border-r-4 border-imigongo-ochre"
            : "md:order-2 border-l-4 border-imigongo-ochre",
        )}
      >
