...
export function ImigongoPatternDecoder() {
  ...
  return (
    <div
      ref={containerRef}
      className="bg-imigongo-ochre min-h-screen relative overflow-hidden flex items-center justify-center"
    >
      ...
      <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center h-full">
        <div ref={leftColRef} className="text-imigongo-black">
        ...
        <div
          ref={rightColRef}
          className="relative h-[60vh] w-full flex items-center justify-center bg-imigongo-black border-4 border-white shadow-2xl"
        >
