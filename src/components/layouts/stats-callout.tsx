...
export default function StatsCallout() {
  return (
    <div className="relative">
      {/* Blue Banner Section */}
      <div className="bg-primary py-20 md:py-28 relative overflow-hidden text-white">
        {/* Decorative elements */}
        ...
        <div className="absolute top-8 right-[30%] text-white/20 text-xl">
          +
        </div>
          ...
          <div className="flex items-start gap-4 max-w-2xl">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm md:text-base max-w-md">
                Don't miss out your chances start vooking now and get the best
                offers
              </p>
            </div>
          </div>

          <Button className="bg-white text-primary hover:bg-white/90 rounded-sm font-semibold px-6 border-none">
            Start Booking
          </Button>
        </div>
      </div>
